...
cumulative as (
    select
        ...
        matchday,
        matchday_points,
        sum(matchday_points) over (partition by team_name order by matchday) as cumulative_points
    from per_matchday
)

select * from cumulative
order by matchday, cumulative_points desc
